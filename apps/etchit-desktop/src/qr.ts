 ...
 *  Returns a self-contained SVG element ready to be rasterised.
 ...
 *  the caller has something meaningful (etch title, filename) —
 *  recipients otherwise have no idea what they're opening. */
